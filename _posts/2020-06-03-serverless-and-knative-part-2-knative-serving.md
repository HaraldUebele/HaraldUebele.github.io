...
In the [first part of this series](https://harald-u.github.io/Installing-Knative/) I went through the installation of Knative on CodeReady Containers which is basically Red Hat OpenShift 4.4 running on a notebook.
...
In my next blog article in this series I will talk about [Knative Eventing](https://harald-u.github.io/Knative-Eventing/).
